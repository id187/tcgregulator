...
- DAY 1부터 실제 운영 화면을 따라 조작하는 스포트라이트형 인수인계(DAY 30 발매·DAY 45 금제를 직접 수행하며, 스킵 결과와 DAY 46 상태 동일)
- 1일 단위 결정론적 메타 시뮬레이션
- 30일마다 기본적으로 신테마 3개 + 구테마 지원 3개의 발매 시안 제시(한쪽 후보가 부족하면 다른 종류로 6안 유지)
- 시안 6개 중 정확히 3개 선택, 각 시안을 7단계(-3~+3)로 파워 조정
- 30일마다 지원 제안 1회, 다음 시안에 제안한 구테마 지원 보장
- DAY 45부터 60일마다 금제위원회 개최(DAY 465 최종 금제 후 DAY 500 결산)
- DAY 47부터 `월 1.05억 + 활성 유저당 2,500원`을 30일로 나눈 운영비가 매일 정산
